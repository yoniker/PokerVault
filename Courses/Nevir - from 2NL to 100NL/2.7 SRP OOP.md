...
Looking at the river, in the following lines:
1. X-B-F (meaning that we checked oop the flop they bet we called, turn went X/X and we led the river)
2. X-X-F (meaning it was checked to the river and then we bet)
3. X-C-F (meaning that flop went X/X, we bet the turn they called, we bet the river they fold)
4. C-X-F (we bet the flop they called, turn went x/x, we bet the river)
5. C-C-F (we triple barrel)

The only line which isn't overfolded is nit+fish vs triple barrel (it feels like the nit/fish make up their minds whether to call down or not on the turn). Every other line/population is overfolded.

## In conclusion

- **Being OOP** means we can’t just range c-bet small on the flop — we have to find other lines to exploit our opponents.
- I used to think **XR** was the best way to apply pressure, but we’ve seen that unless you’re playing against a reg who leads too many bluffs (because he knows people XF too often), XR isn’t a good option — most players underfold and over-3-bet.

---

- Even though we’re OOP, a **high-frequency c-bet strategy** still works really well, as all types of players tend to overfold against any bet size.
- That said, **checking** is still a strong line, since people overfold in any line after they XB the flop.

---

💡 **Whatever sizing or line you choose, keep in mind that:**  
Every line is overfolded — so play very aggressively.
Stop overthinking blockers and equity. Start thinking more like:

> *"My opponent XB the flop — I don’t need blockers or equity. Let’s bluff."*



If I'm early position vs the BU, he will have a lot of decent hands like pocket pairs that didn't want to 3-bet and didn't want to fold, so i need to check at a very high frequency, and then when they check back Nevir likes to apply pressure since they overfold.