...
Now let's take a look at what happens after flop went X (we checked OOP) X on the turn:
## Population’s strategy after XB the flop  
*(all players type and positions) (data from Mobius poker)*

|               | Population fold | GTO fold |
| ------------- | --------------- | -------- |
| **Overall**   | 45              | 47       |
| **B100 turn** | 66              | 51       |
| **B70 turn**  | 54              | 40       |
...
So, the players are overfolding on the turn after checking back, meaning that I should increase my bet frequency by a lot.

Nevir recommends, OOP as 3-bettor, when i do check and he bets, to either X/R or X/F, almost never X/C because a common mistake is people overfold on the turn